...
function createAnnouncement(
  ...
  conflicts: ReadonlyArray<BoardProps.Item<WidgetData>>,
  disturbed: ReadonlyArray<BoardProps.Item<WidgetData>>,
) {
...
export const boardI18nStrings: BoardProps.I18nStrings<WidgetData> = {
