...
export const services: ServiceInfo[] = [
  ...
  },
  {
    key: "firehose",
    name: "Data Firehose",
    description: "Stream data to destinations",
    href: "/services/firehose",
    aliases: ["firehose", "delivery stream", "kinesis firehose", "ingest", "etl", "streaming"],
  },
  {
    key: "glue",
    name: "Glue",
    description: "Data catalog and ETL",
    href: "/services/glue",
    aliases: ["catalog", "database", "table", "etl", "crawler", "data catalog", "metastore"],
  },
  {
    key: "opensearch",
    name: "OpenSearch",
    ...
    aliases: ["search", "elasticsearch", "elastic", "domain", "kibana", "opensearch service"],
  },
  {
    key: "appsync",
    name: "AppSync",
    description: "Managed GraphQL APIs",
    href: "/services/appsync",
    aliases: ["graphql", "api", "resolver", "data source", "subscription", "realtime"],
  },
  {
    key: "scheduler",
    name: "EventBridge Scheduler",
    description: "Scheduled tasks and cron",
    href: "/services/scheduler",
    aliases: ["schedule", "cron", "rate", "scheduler", "eventbridge scheduler", "timer"],
  },
  {
    key: "efs",
    name: "EFS",
    description: "Elastic file system storage",
    href: "/services/efs",
    aliases: ["file system", "nfs", "shared storage", "mount", "elastic file system"],
  },
  {
    key: "cloudtrail",
    name: "CloudTrail",
    description: "API activity and audit logs",
    href: "/services/cloudtrail",
    aliases: ["audit", "trail", "events", "api activity", "logging", "governance"],
  },
  {
    key: "backup",
    name: "Backup",
    description: "Centralized backups",
    href: "/services/backup",
    aliases: ["backup", "vault", "recovery point", "restore", "snapshot"],
  },
  {
    key: "organizations",
    name: "Organizations",
    ...
    aliases: ["accounts", "org", "ou", "organizational unit", "consolidated billing", "scp"],
  },
];
